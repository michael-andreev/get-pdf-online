...
namespace PrecizeSoft.GetPdfOnline.Api.MvcCoreApp.Swagger
{
    internal class FormFileOperationFilter : IOperationFilter
    {
        ...
        public void Apply(Operation operation, OperationFilterContext context)
        {
            ...
            if (!containerParams.Any())
            {
                ...
                foreach (var parameter in formFileParams)
                {
                    parameters.Add(new NonBodyParameter
                    {
                        ...
                        In = "formData" //Moved from the end of method
                    });
                }
            }
            else
            ...
            //If operation contains parameters in Path, it doesn't work
